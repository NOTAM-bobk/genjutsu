...
export type ThemePreset = "default" | "minecraft" | "win95" | "papyrus" | "hackernews" | "winxp" | "vicecity" | "gameboy" | "nord" | "terminal";
...
export function ThemeProvider({
    ...
    const [preset, setPresetState] = useState<ThemePreset>(() => {
        ...
        if (stored === "minecraft" || stored === "win95" || stored === "papyrus" || stored === "hackernews" || stored === "winxp" || stored === "vicecity" || stored === "gameboy" || stored === "nord" || stored === "terminal") {
