...
export const StrangerChat = ({ currentUserName }: { currentUserName: string }) => {
  const { status, messages, sendMessage, startSearch, stopSearch, strangerName, onlineCount, isStrangerTyping, sendTypingIndicator } = useStrangerMatch(currentUserName);
